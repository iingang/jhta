      ...
      <div id="header">
         <div class="top-wrapper">
            ...
            <ul id="membermenu" class="clear">
               ...
               <li>
                  <a href="../customer/notice/list"><img src="../images/menuCustomer.png" alt="고객센터" /></a>
               </li>
            </ul>
         </div>
      </div>
               ...
               <div id="join-form" class="join-form margin-large" >                  
                  ...
                  <fieldset>
                                ...
                                <p>
                                	...
                                	<input type="submit" id="btnLogin" value="" /></p>
                                <ul id="loginOption">
