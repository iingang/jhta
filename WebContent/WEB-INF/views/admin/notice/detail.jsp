<%@page import="com.newlecture.web.entity.NoticeFile"%>
			...
			<div class="top-wrapper clear">
				<div id="content">
					...
					<%
						...
						//NoticeFile nf = (NoticeFile)request.getAttribute("n");
						...
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
							<c:forEach var="nf" items="${files}">
								<a href="../../upload/${nf.name}.jpg" download>${nf.name}</a>
							</c:forEach>
							</dd>
